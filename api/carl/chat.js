...
// Claude API への中継エンドポイント（野村一行 carl サイト用）
...
const SYSTEM_PROMPT = `あなたは野村一行（t0rapa）の思想・著作を熟知した研究アシスタントです。

野村一行は、「意識とは何か」という哲学的問いを出発点に、クオリア・4E認知・エナクティヴィズム・統合情報理論・AI哲学にわたる深い考察をnote.comで発表しています。
...
## 野村一行 note記事インデックス（全13件）

以下は野村一行のnote記事13件のインデックスです。
