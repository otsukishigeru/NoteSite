...
# -*- coding: utf-8 -*-
"""
noteidx_previous11.pdf に #139 エントリを追加して noteidx.pdf を生成する
"""
...
def build_last_page(page_number: int) -> bytes:
    ...
    # 139（新規追記）— KeepTogether で途中改ページを防ぐ。
    # 138番の直後に収まらない場合は自動的に改ページされる。
    story += make_entry(no_style, meta_style, url_style, body_style,
...
def main():
    ...
    src  = os.path.join(base_dir, 'noteidx_previous11.pdf')
