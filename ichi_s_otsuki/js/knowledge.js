// =============================================
// js/knowledge.js — 1_s_o note記事インデックス（全143件）
// 更新タイミング：新記事追加時
...
const knowledge = [
  ...
  {
    num: "127",
    title: "AIトークンエコノミー — 知働化サイトのコストモデル（AI-COCOMOモデル）を事例として",
    category: "ソフトウェア工学",
    date: "2026-04-13",
    summary: "COCOMO IIを生成AI時代に拡張した「AI-COCOMOモデル」を提案。知働化サイト実装データに基づき、従来型・AI支援・AI最大委任の3シナリオで開発コストを試算。AIへの委任が増すほどコストは「作るコスト」から「確認するコスト」へ転換し、人間の役割はビジョン定義・ドメイン判断・品質承認に集中することを論じる。chidouka-lab.com/AI-COCOMO/ でWebシミュレータも公開。",
  ...
  },
  {
    ...
    category: "組織論",
    date: "2026-04-21",
    summary: "建築の「構造計算」を現代のITシステム・組織設計のメタファとして援用し、ISO/IEEE等の標準規格による信頼性保証の役割を概観する。複雑化するAI時代において、第三者視点からプロセス・構造の正しさを客観的に評価する「構造計算経営」の重要性を提唱する。",
    url: "https://note.com/ichi_s_otsuki/n/ne5c487b3fad9"
  },
  {
    num: "129",
    title: "AI・哲学の知政学",
    category: "哲学",
    date: "2026-04-27",
    summary: "著名な思想家の哲学を存在論・認識論の2軸で4象限にマッピングし、AIの立ち位置と人類の針路を整理する。知識・アルゴリズムの支配権闘争を「知政学」と定義し、未来への羅針盤として「知能の地図」を提示する。",
    url: "https://note.com/ichi_s_otsuki/n/n2631177010e4"
  },
  {
    num: "130",
    title: "思考の技法 2.0",
    category: "思考の技法",
    date: "2026-05-10",
    summary: "前作『思考の技法』の課題と生成AIの急速な普及を踏まえ、AI時代におけるHI（人間知能）の役割を浮き彫りにする『思考の技法2.0』の脱稿とその構成を解説する。AI（思考モデル）とHI（思考）が協働する次世代のパラダイム像を描き出し、知識主導社会における新たな価値創造の方向性を提示。知働化コミュニティサイトを通じた本書の公開・販売の仕組みについても報告している。",
    url: "https://note.com/ichi_s_otsuki/n/nb0eef1812e78"
  },
  {
    num: "131",
    title: "思考の技法 2.0",
    category: "思考の技法",
    date: "2026-05-11",
    summary: "『思考の技法２．０』への読者コメントを受け、AIエージェント内のモデル化（意味や文脈の階層）と、エージェント間のモデル化（「思考の社会」としての振る舞い）について深掘りする。AIの知能が集団知性に似た構造から生まれることを考察し、『思考の技法３．０』に向けた次なる探求の方向性を提示する。",
    url: "https://note.com/ichi_s_otsuki/n/nc9259e103c5f"
  },
  {
    num: "132",
    title: "AI人材アセスメント",
    category: "AI時代",
    date: "2026-05-18",
    summary: "『思考の技法 2.0』に基づき、AI時代に求められる人材像を「成人発達理論」の観点から評価（アセスメント）する手法を解説する。採用面接や日常観察で応用できる具体的な判定基準（ルールの設計能力や認識する他者の範囲など）と質問例を実践的に提示している。陳腐化しやすいスキルではなく普遍的な能力を育成し、人間がAIの「コンダクター」として意味の創造に集中することの重要性を論じた論考。",
    url: "https://note.com/ichi_s_otsuki/n/na93ac576f509"
  },
  {
    num: "133",
    title: "知働化コミュニティへの転回",
    category: "知働化",
    date: "2026-05-26",
    summary: "アジャイルプロセス協議会の終了に伴い、知働化研究会が「知働化コミュニティ」として独立・転回する背景と今後の方向性を論じる。過去の活動の歩みを振り返りつつ、AIの進化を踏まえて「知働化」概念を再定義し、HIとAIの思考法や用法を探求する目的を提示する。個と組織の新たな世界観・価値観を示す、次なるコミュニティ活動の実践的展望。",
    url: "https://note.com/ichi_s_otsuki/n/n0aad8c53c12d"
  },
  {
    num: "134",
    title: "自由エネルギー原理と『思考の技法 2.0』",
    category: "思考の技法",
    date: "2026-06-05",
    summary: "カール・フリストンの「自由エネルギー原理」を『思考の技法』の視点から読み解き、脳の認識や意思決定の計算モデルとその哲学的背景を論じる。思考の技法の中心概念である「目的・コミュニケーション・抽象化」や、オートポイエーシス論との関連を再考している。脳科学の「大統一理論」が、今後のAIや組織・システム設計にもたらす新たな可能性を探求する実践的論考。",
    url: "https://note.com/ichi_s_otsuki/n/nf0120cd3f914"
  },
  {
    num: "135",
    title: "思考の技法 2.0 / 進化プロセス",
    category: "思考の技法",
    date: "2026-06-28",
    summary: "AIを徹底活用するためのアーキテクチャとして、オントロジー（構造）、セマンティクス（意味）、エージェント（行為）の三層の分離と連結を提示する。人間の認識階層や自由エネルギー原理を評価プロセスに組み込み、自己評価を行う内省ループによって知識体系を自律的に改善・進化させる設計思想を論じる。静的な知識グラフと動的な推論を噛み合わせ、自己改善するシステムを構築するための実践的論考。",
    url: "https://note.com/ichi_s_otsuki/n/nad2408300e20"
  },
  {
    num: "136",
    title: "ロボティクス・アーキテクチャの構想",
    category: "システム学",
    date: "2026-07-09",
    summary: "生成AIの実用化を前提とし、AIのフレーム問題への処方箋として「問題フレーム」を位置づけたロボットシステムの設計方法論を構想する。意味を扱う4層と時間スケールの3層制御、自由エネルギー原理の閉ループからなるアーキテクチャを提示。さらに、意図の定義から段階的進化に至る8ステップのデザイン技法を構成し、人間・AI・フレームの役割を整理する。",
    url: "https://note.com/ichi_s_otsuki/n/nbce4c5884cb7"
  },
  {
    num: "137",
    title: "ロボティクス・アーキテクチャの構想へのコメント",
    category: "システム学",
    date: "2026-07-21",
    summary: "「ロボティクス・アーキテクチャの構想」に寄せられた計8回のコメントへの見解と、それに伴う設計の改稿方針を統合した論考。AIと人間の役割分担の明確化や、エージェントに対し知識グラフを非公開（カプセル化）にする工学的な境界設計など、現実のスケールに耐えうる実装知見を提示している。さらに、記号的なオントロジーと連続的な世界モデルを潜在空間を介して動的に結合させる構成法など、自由エネルギー原理とも整合するアーキテクチャの精緻化について論じている。",
    url: "https://note.com/ichi_s_otsuki/n/nee399d526896"
  },
  {
    num: "138",
    title: "ロボティクス・アーキテクチャの構想：改訂版",
    category: "システム学",
    date: "2026-07-21",
    summary: "生成AIの実用化を前提に、AIのフレーム問題への処方箋として「問題フレーム」を位置づけたロボットシステムの設計方法論を構想する。意味を扱う4層と時間スケールの3層制御、自由エネルギー原理の閉ループからなるアーキテクチャを提示。意図の定義から段階的進化に至る8ステップのデザイン技法を構成し、人間・AI・フレームの役割を整理する。",
    url: "https://note.com/ichi_s_otsuki/n/nee7edc6e64fb"
  },
  {
    num: "139",
    title: "ラディカル・AI社会",
    category: "AI時代",
    date: "2026-08-03",
    summary: "生成AIの発達による社会構造の変貌と、人財が「創造的カテゴリー」と「技能的カテゴリー」に二極化していく原理を『思考の技法 2.0』に基づき急進的（ラディカル）な視点で考察する。自動化・機械化により技能的作業がAIに代替される中、新しい価値や「目的」を創造するイノベーションこそが人間に残された役割であると提示する論考。",
    url: "https://note.com/ichi_s_otsuki/n/n0a6d6bb95e4c"
  },
  {
    num: "140",
    title: "『思考の技法2.0』のエッセンス",
    category: "思考の技法",
    date: "2026-08-12",
    summary: "書籍『思考の技法 2.0』の骨格となる「目的」「抽象化／具体化」「コミュニケーション」の三本柱の関係性を整理。背景哲学である新実在論に基づき、実務で混同されやすい「意味の場」と「ドメイン」の違いを明確に定義する。具体化はAIに委ねつつ、目的を伴う抽象化は人間が担うべき領域として残るという、AI時代の役割分担を提示する解説資料。",
    url: "https://note.com/ichi_s_otsuki/n/n6cb9fb04e262"
  },
  {
    num: "141",
    title: "AI時代の要求工学【概説編】",
    category: "AI時代",
    date: "2026-08-24",
    summary: "生成AIの登場によってシステム実装のコストがゼロに近づく時代における、人間の本質的な役割となる新たな要求定義の在り方を提示した概説。従来の「作るのが高い」という前提から派生した古い常識を棄却し、「目的」「抽象山」「意味の場」の3つの核心概念を整理する。5つの局面と8つの原理からなる「知働化要求定義」の手順に加え、「超マシン記述」など実践的な5つの技法をわかりやすく解説している。",
    url: "https://note.com/ichi_s_otsuki/n/n8f5a693fab52"
  },
  {
    num: "142",
    title: "Symposium2026開催予定",
    category: "シンポジウム",
    date: "2026-09-07",
    summary: "2026年11月14日に開催予定の第4回「Symposium2026」の開催概要と趣旨を解説した論考。アジャイルプロセス協議会の終了に伴う「知働化コミュニティ」への再スタートや、高野明彦氏による「連想情報学」とボーム・ダイアローグに関する基調講演の構想を提示している。さらに「AI活用の実践原理と哲学」「要求工学新時代の人間の役割」をテーマとする2つの並行トラックのセッション構成と議論の狙いを整理している。",
    url: "https://note.com/ichi_s_otsuki/n/n53d3c17b0d64"
  },
  {
    num: "143",
    title: "文筆という活動",
    category: "思考の技法",
    date: "2026-09-22",
    summary: "note執筆143作目を迎えた著者が、AI活用を踏まえた「文筆活動」の変容と本質を論じた論考。問題設定や定式化といった創造的活動は人間が担い、調査・推敲・ビジュアル化などの技能的活動にAIを限る役割分担の重要性を提唱している。執筆を通じた概念の解像度向上を「抽象山」のメタファーで捉え直し、人間の意図に基づくテキストの蓄積と継続的探求の大切さを提示している。",
    url: "https://note.com/ichi_s_otsuki/n/n925c817dee8c"
  }
];
